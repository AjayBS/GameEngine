...
void Shutdown()
{
	DEBUG_CONSOLE( "Job System: Shutting down.\n" );
	...
	DEBUG_CONSOLE( "Job System: Waiting for Queue runner threads to shut down.\n" );
...
void RunJob( IJob & i_Job, const HashedString & i_QueueName )
{
	...
	DEBUG_CONSOLE( "Job System: Adding Job to Queue \"%s\".\n", existing->second->m_SharedQueue.GetName() );
